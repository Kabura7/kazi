            ...
            <div className="relative">
              ...
              <AnimatePresence>
                ...
                y: -10
                    ...
                    <Link to="/login?type=attorney" className="block px-4 py-2 text-gray-700 hover:bg-gray-100" onClick={() => setIsLoginDropdownOpen(false)}>
                      Attorney
                    </Link>
                  </motion.div>}
              </AnimatePresence>
            ...
            <div className="relative">
              ...
              <AnimatePresence>
                ...
                y: -10
                    ...
                    <Link to="/signup?type=attorney" className="block px-4 py-2 text-gray-700 hover:bg-gray-100" onClick={() => setIsSignupDropdownOpen(false)}>
                      Attorney
                    </Link>
                  </motion.div>}
              </AnimatePresence>
